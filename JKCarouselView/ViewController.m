...
#import "JKCarouselView/JKCarouselView.h"

@interface ViewController ()<JKCarouselViewDelegate>
@property (nonatomic, strong) JKCarouselView *carouselView;
@property (weak, nonatomic) IBOutlet JKCarouselView *carouselView1;
@end
...
- (void)viewDidLoad {
     ...
     *  通过代码创建
     */
    _carouselView = [[JKCarouselView alloc] initWithFrame:CGRectMake(0, 100, [UIScreen mainScreen].bounds.size.width, 180)];
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    [JKCarouselView clearDiskCache];
}


#pragma mark JKCarouselViewDelegate
- (void)carouselView:(JKCarouselView *)carouselView clickImageAtIndex:(NSInteger)index {
